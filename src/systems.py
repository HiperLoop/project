...
def solar_system(animate=True, ani_params=Animation_parameters(plot_axis_limits=40, plot_dimension=3, frame_rate=40)):
    ...
    bodies = [sun] + planets
    solar_system = System(animate=animate, from_file=False, name="Solar system", bodies=bodies, simulation_parameters=Simulation_parameters(dimension=3, do_norming=True, step_time=0.1, precision=1, step_iterations=100000), animation_parameters=ani_params)
    solar_system.run()
