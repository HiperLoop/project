...
def main():
    ...
    #user_input()
    system_from_user_input(['Sun', 'Rocket'], animate=True, dimension=2, simulation_parameters=Simulation_parameters(dimension=2), animation_parameters=Animation_parameters(plot_dimension=2, plot_axis_limits=4))
